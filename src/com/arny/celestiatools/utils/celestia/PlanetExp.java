...
public class PlanetExp {
    ...
    private static Xyz getPosExp0(double fT) {
        double fLambda = 279.0358 + 360.00769 * fT + (1.9159 - 0.00005 * fT) * UdMath.udsin((356.531) + (359.991) * fT);
        ...
        double fq = (-0.007261 + 0.0000002 * fT) * UdMath.udcos((356.531) + (359.991) * fT) + 0.000030;
        ...
        return new Xyz(-fRadius * Math.cos(fBeta) * Math.cos(fLambda), -fRadius * Math.cos(fBeta) * Math.sin(fLambda), -fRadius * Math.sin(fBeta));
    }
    ...
    private static Xyz getPosExp1(int planetNo, double fT) {
        ...
        double L1 = (ParamP.L6 + ParamP.L7 * fT) * UdMath.udsin(ParamP.L8 + ParamP.L9 * fT);
        for (int i = 0; i < ParamL1.length; i++) {
            L1 += ParamL1[i].a * UdMath.udsin(ParamL1[i].b + ParamL1[i].c * fT);
        }
        double L0 = ParamP.L1 + ParamP.L2 * fT + ParamP.L3 * UdMath.udsin(ParamP.L4 + ParamP.L5 * fT + 2.0 * L1);
        ...
        double fBeta = Math.asin(ParamP.B1 * UdMath.udsin(ParamP.B2 + ParamP.B3 * fT + L1));
        double fq = (ParamP.q1 + ParamP.q2 * fT) * UdMath.udcos(ParamP.q3 + ParamP.q4 * fT) + ParamP.q5;
