...
public class ATime {
	 ...
	 */
	public ATime(int nYear, int nMonth, int nDay, int nHour, int nMin, double fSec, double fTimezone) {
		this.nYear = nYear;
		this.nMonth = nMonth;
		this.nDay = nDay;
		this.nHour = nHour;
	...
	public static double getEp(double fJd) {
		...
		double fEp = 23.43929111
				...
				- 0.00059 / 60.0 / 60.0 * MathUtils.Exp(ft,2)
				+ 0.001813 / 60.0 / 60.0 * MathUtils.Exp(ft,3);
