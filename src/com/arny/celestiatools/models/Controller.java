...
public class Controller {
    ...
    private static final String MPC_NEAM_LAST_SCC = "mpc_neam_last.scc";
            ...
            for (int i = 0; i < asteroids.size(); i++) {
                ...
                try {
                    ...
                    if (astroObject.get("Name")==null) {
                        ...
                        neamParseBuilder.append("\n\"").append(astroObject.get("Name").toString()).append("\"");
                        if (astroObject.get("Principal_desig")!=null) {
                            neamParseBuilder.append(":\"").append(astroObject.get("Principal_desig").toString()).append("\"");
                        }
                    }
                    neamParseBuilder
